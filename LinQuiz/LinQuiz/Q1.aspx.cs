    ...
    public partial class Q1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                wylosowaneLabel.Text = Session["Q1"].ToString();

                SqlCommand cmd1b = new SqlCommand("SELECT definicja_id FROM slowko WHERE nazwa=@slowko;", con);
                cmd1b.Parameters.AddWithValue("@slowko", Session["Q1"].ToString());
        ...
        protected void sendButton_Click(object sender, EventArgs e)
        {
            ...
            if (dr.HasRows)
            {
                while (dr.Read())
                {
                    ...
                    if (wylosowanaDefinicja == wybranaDefinicja)
                    {
                        ...
                        //Convert.ToInt32(Session["poprawne_odp"]);
            ...
            //wybraneDefinicja = (int)cmd2.ExecuteScalar();

            //if (wylosowaneDefinicja == wybraneDefinicja)
            //{
            //    checkLabel.Text = "ok";
            //}
            //else
            ...
            //odp_id = (int)cmd3.ExecuteScalar();
            //defLabel.Text = Convert.ToString(definicja);
